                ...
                <div class="space-y-8">
                    ...
                    <div class="col-sm-12">
                        <div class="flex flex-row justify-center">
                            ...
                            <div>
                                <img src="{{ asset('storage/'.$gallery->image()) }}" alt="default image" class="rounded-full h-20 w-20 object-cover" id="first">
                            </div>
                        </div>
                    </div>
                    
                    <x-form action="{{ route('vendor.gallery.update', $gallery) }}" has-files>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div>
                                    ...
                                    <x-form.input id="name" class="block w-full mt-1" type="text" name="name" :value="old('name',$gallery->name())" :value="$gallery->name()" required />
