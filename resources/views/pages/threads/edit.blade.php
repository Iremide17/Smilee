<x-app-layout>
    ...
    <x-slot name="header">
        <h2 class="text-xl font-semibold leading-tight text-gray-50">
         {{ __('Thread Edit:') }} {{ $thread->title() }}
        </h2>
        <p>
            <small class="text-sm text-white">threads>{{ $thread->title() }}>edit</small>
        </p>
    </x-slot>
    <div class="col-md-12 gap-8 mt-8">
        ...
        <section class="flex flex-col col-span-3 gap-y-4">
            <article class="p-5 bg-white shadow">
                <div class="w-full">
                    ...
                    {{-- Create --}}
                    <div class="space-y-6">
                        <x-form action="{{ route('smilee.threads.update', $thread->slug()) }}">
                            <div class="space-y-8">
