<x-jet-form-section submit="updateSocialLink">
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-jet-input id="facebook" type="text" class="block w-full mt-1" wire:model.defer="vendor.facebook" />
            <x-jet-input-error for="facebook" class="mt-2" />
        </div>

        <div class="col-span-6 sm:col-span-4">
            <x-jet-label for="'twitter'" value="{{ __('Twitter') }}" />
            <x-jet-input id="twitter" type="text" class="block w-full mt-1" wire:model.defer="vendor.twitter" />
            <x-jet-input-error for="twitter" class="mt-2" />
        </div>

        <div class="col-span-6 sm:col-span-4">
            <x-jet-label for="instagram" value="{{ __('Instagram') }}" />
            <x-jet-input id="instagram" type="text" class="block w-full mt-1" wire:model.defer="vendor.instagram" />
            <x-jet-input-error for="instagram" class="mt-2" />
        </div>

        <div class="col-span-6 sm:col-span-4">
            <x-jet-label for="linkedin" value="{{ __('Linkedin') }}" />
            <x-jet-input id="linkedin" type="text" class="block w-full mt-1" wire:model.defer="vendor.linkedin" />
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-jet-input id="bio" type="text" class="block w-full mt-1" wire:model.defer="vendor.bio" />
    ...
    <x-slot name="actions">
        <x-jet-action-message class="mr-3" on="updated">
            {{ __('updated other vendor informations.') }}
