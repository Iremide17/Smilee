    ...
    <div class="py-6">
        <div class="mx-auto max-w-8xl sm:px-6 lg:px-8">
                <div class="space-y-8">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="flex flex-row justify-center">
                                    ...
                                    <div>
                                        <img src="{{ asset('storage/'.$product->firstImage()) }}" alt="default image" class="rounded-full h-20 w-20 object-cover" id="first">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                                <div class="flex flex-row justify-center">
                                    ...
                                    <div>
                                        <img src="{{ asset('storage/'.$product->secondImage()) }}" alt="default image" class="rounded-full h-20 w-20 object-cover" id="second">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                                <div class="flex flex-row justify-center">
                                    ...
                                    <div>
                                        <img src="{{ asset('storage/'.$product->thirdImage()) }}" alt="default image" class="rounded-full h-20 w-20 object-cover" id="third">
                                    </div>
                                </div>
                            </div>
                    ...
                    <x-form action="{{ route('vendor.product.update',$product) }}" has-files>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                {{-- title --}}
                                <div>
                                    <x-form.label for="title" value="{{ __('Product Title') }}" />
                                    <x-form.input id="title" class="block w-full mt-1" type="text" name="title" :value="old('title',$product->title())" required />
                            ...
                            <div class="col-sm-6 mb-2">
                                ...
                                <x-form.input id="price" class="block w-full mt-1" type="number" name="price" :value="$product->price()" />
                                <x-form.error for="price" />
                            </div>

                            {{-- category --}}
                            <div class="col-sm-6 mb-2">
                                <x-form.label for="category_id" value="{{ __('Product Category') }}" />
                            ...
                            <div class="col-sm-6 mb-2">
                                ...
                                <select name="type" id="type" class="w-full text-sm border-gray-300 rounded-md shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                                    <option value="old" @if($product->type() === 'old') selected @endif>Old</option>
