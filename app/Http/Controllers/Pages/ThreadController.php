...
class ThreadController extends Controller
{
    ...
    public function store(ThreadStoreRequest $request)
    {
        ...
        return redirect()->route('smilee.threads.index')->with('success', 'Thread created!');
    }
    ...
    public function update(ThreadStoreRequest $request, Thread $thread)
    {
        ...
        return redirect()->route('smilee.threads.index')->with('success', 'Thread Updated!');
    }
    ...
    public function subscribe(Request $request, Category $category, Thread $thread)
    {
        ...
        return redirect()->route('smilee.threads.show', [$thread->category->slug(), $thread->slug()])
